...
echo '<input type="time" name="'. MetaBox::GLOBAL_POST_KEY .'[timeStart][]" class="widefat time-start" value="'. $timeStart .'" />';
echo '</td>';

echo '<td class="col-time-end">';
echo '<input type="time" name="'. MetaBox::GLOBAL_POST_KEY .'[timeEnd][]" class="widefat time-end" value="'. $timeEnd .'" />';
echo '</td>';
