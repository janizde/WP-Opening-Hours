...
echo '<input type="text" name="'. MetaBox::GLOBAL_POST_KEY .'[name][]" class="widefat" value="'. $name .'" />';
echo '</td>';

echo '<td class="col-date">';
echo '<input type="date" name="'. MetaBox::GLOBAL_POST_KEY .'[date][]" class="widefat" value="'. $date .'" />';
echo '</td>';

echo '<td class="col-time-start">';
echo '<input type="time" name="'. MetaBox::GLOBAL_POST_KEY .'[timeStart][]" class="widefat" value="'. $timeStart .'" />';
echo '</td>';

echo '<td class="col-time-end">';
echo '<input type="time" name="'. MetaBox::GLOBAL_POST_KEY .'[timeEnd][]" class="widefat" value="'. $timeEnd .'" />';
echo '</td>';
